...
class API {
  ...
  async request(url, opts, retry) {
    ...
    if (contentType.indexOf('application/json') !== -1 || url.indexOf('jscode2session') !== -1) { // FIXME: code2session这个接口太奇葩，返回的是plain/text @see https://developers.weixin.qq.com/community/develop/doc/00048ce0070560a54c38b190f56800?_at=1558717527782
      var data;
